...
//
// onde 'c' e 's' são o coseno e o seno do ângulo de rotação, respectivamente.
...
// ser definida pela fórmula de Rodrigues. Lembre-se que o vetor deve ser
// normalizado!
